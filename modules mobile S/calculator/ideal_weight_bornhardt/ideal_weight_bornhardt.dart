// lib/features/ideal_weight/ideal_weight_bornhardt_view.dart
//
// ✅ Logique de calcul Bornhardt inchangée
// ✅ Suppression de la traduction (intl/localization)
// ✅ Nouveau design identique à BeepIntermittentTrainingView
// ✅ Pas de TabBar / TabBarView
// ✅ Même fond premium + overlay + glass cards + animations
// ✅ Résultats et infos intégrés dans un seul scroll moderne
...
/// ✅ Textes locaux (sans localization)
class _TXT {
  static const String screenTitle = "Ideal Weight Bornhardt";

  static const String introTitle = "Méthode Bornhardt";
  static const String introSubtitle =
      "Calcule le poids idéal à partir de la taille et du tour de poitrine.";

  static const String calcTitle = "Calculateur";
  static const String calcDesc =
      "Saisis la taille et le tour de poitrine, puis lance le calcul.";

  static const String height = "Taille";
  static const String chestCircumference = "Tour de poitrine";
  ...
  static const String formulaTitle = "Formule Bornhardt";
  static const String formula = "(Taille (cm) × Tour de poitrine (cm)) / 240";

  static const String infoTitle = "À propos de la méthode";
  static const String infoBody1 =
      "La formule de Bornhardt est une méthode classique d’estimation du poids idéal. "
      "Elle utilise deux mesures simples : la taille et le tour de poitrine.";

  static const String infoBody2 =
      "Cette formule donne une estimation théorique. Elle ne remplace pas une évaluation "
      "médicale ou sportive complète et doit être interprétée avec prudence.";

  static const String infoBody3 =
      "Le résultat est utile comme repère général, mais il ne tient pas compte de la masse "
      "musculaire, du taux de graisse corporelle, de l’âge ou du sexe.";

  static const String chipMethod = "Méthode Bornhardt";
  static const String chipEstimate = "Estimation rapide";
  static const String chipResult = "Résultat";

  static const String heightHint = "0";
  static const String chestHint = "0";
...
class _IdealWeightBornhardtViewState extends State<IdealWeightBornhardtView>
  ...
  final TextEditingController chestCtl = TextEditingController(text: "0");
  ...
  void _compute() {
    ...
    final c = _safeDouble(chestCtl.text);
    ...
    // ✅ Logique inchangée
    // Bornhardt: (taille (cm) × tour de poitrine (cm)) / 240
    final kg = (h * c) / 240.0;
                                  ...
                                  const SliverToBoxAdapter(
                                    child: Padding(
                                      ...
                                      child: _ImageInfoCard(
                                        ...
                                        title: "Définition",
                                        body:
                                            "La méthode Bornhardt relie la taille et le tour de poitrine pour proposer un poids théorique de référence.",
                                      ),
                                    ),
                                  ),
                                  ...
                                  const SliverToBoxAdapter(
                                    child: Padding(
                                      ...
                                      child: _ImageInfoCard(
                                        ...
                                        body:
                                            "Cette estimation reste générale. Elle doit être comparée à d’autres indicateurs pour une analyse plus complète.",
                                      ),
                                    ),
                                  ),
    ...
    return _Glass(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 10),
          const _PillIconStatic(icon: Icons.straighten_rounded),
        ],
      ),
    );
  }
...
class _CalcCard extends StatelessWidget {
  ...
  final TextEditingController chestCtl;
  final VoidCallback onCompute;

  const _CalcCard({
    required this.heightCtl,
    required this.chestCtl,
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(
                child: _NumberField(
                  label: "${_TXT.chestCircumference} (${_TXT.cm})",
                  hint: _TXT.chestHint,
                  controller: chestCtl,
                ),
              ),
    ...
    return _Glass(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            hasResult
                ? "Le résultat affiché correspond à l’estimation du poids idéal selon la formule de Bornhardt."
