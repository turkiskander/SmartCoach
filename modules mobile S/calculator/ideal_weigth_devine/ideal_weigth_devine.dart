// lib/features/.../ideal_weigth_devine_view.dart
//
// ✅ Logique Devine inchangée
...
class _TXT {
  static const String screenTitle = "Ideal Weight Devine";

  static const String introTitle = "Méthode de Devine";
  ...
  static const String calcDesc =
      "Saisis la taille, choisis le sexe, puis lance le calcul.";
  ...
  static const String chipMethod = "Méthode Devine";
  ...
  static const String infoBody1 =
      "La méthode de Devine est une formule de référence souvent utilisée pour estimer le poids idéal à partir de la taille et du sexe.";
  static const String infoBody2 =
      "La formule utilise une base de 60 pouces, soit 152,4 cm, puis ajoute une valeur fixe pour chaque pouce supplémentaire.";
  static const String infoBody3 =
      "Chez l’homme, la base utilisée est différente de celle de la femme, ce qui modifie le résultat final.";
  static const String infoBody4 =
      "Cette estimation reste théorique et ne tient pas compte de la masse musculaire, de la morphologie ou de l’activité physique.";
  static const String infoBody5 =
      "Le résultat doit être considéré comme un repère général et non comme une mesure absolue.";

  static const String formulaTitle = "Formule Devine";
  ...
  static const String resultHint =
      "Le résultat affiché correspond à l’estimation du poids idéal selon la formule de Devine.";
...
class _IdealWeigthDevineViewState extends State<IdealWeigthDevineView>
  ...
  void _compute() {
    ...
    // ✅ Logique inchangée
    // Devine: base 60 inches (152.4 cm)
    final inches = h * 0.3937008;
    final extra = inches > 60 ? (inches - 60) : 0.0;
    final isMale = (sexCtl.text == _TXT.sexValue3);
                                  ...
                                  const SliverToBoxAdapter(
                                    child: Padding(
                                      ...
                                      child: _ImageInfoCard(
                                        ...
                                        body:
                                            "La méthode de Devine convertit d’abord la taille en pouces, puis applique une formule différente selon le sexe.",
                                      ),
                                    ),
                                  ),
                                  const SliverToBoxAdapter(
