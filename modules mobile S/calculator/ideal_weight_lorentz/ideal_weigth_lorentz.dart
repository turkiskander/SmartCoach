// lib/features/.../ideal_weigth_lorentz_view.dart
//
// ✅ Logique Lorentz inchangée
...
// ✅ Images + infos conservées dans une seule interface scrollable
...
class _TXT {
  static const String screenTitle = "Ideal Weight Lorentz";

  static const String introTitle = "Méthode de Lorentz";
  static const String introSubtitle =
      "Estime le poids idéal selon la taille et le sexe.";

  static const String calcTitle = "Calculateur";
  static const String calcDesc =
      "Choisis le sexe, saisis la taille, puis lance le calcul.";
  ...
  static const String chipMethod = "Méthode Lorentz";
  static const String chipEstimate = "Estimation rapide";

  static const String formulaTitle = "Formules de Lorentz";
  static const String formulaMale =
      "Poids idéal (Homme) = H − 100 − ((H − 150) / 4)";
  static const String formulaFemale =
      "Poids idéal (Femme) = H − 100 − ((H − 150) / 2.5)";

  static const String infoTitle = "À propos de la méthode";
  static const String infoBody1 =
      "La méthode de Lorentz est une formule classique utilisée pour estimer le poids idéal à partir de la taille et du sexe.";

  static const String infoBody2 =
      "Elle reste simple à utiliser et donne une estimation rapide, mais elle ne remplace pas une évaluation médicale ou sportive complète.";

  static const String infoBody3 =
      "Le résultat ne prend pas en compte la masse musculaire, la morphologie, l’âge ou le niveau d’activité physique.";

  static const String infoBody4 =
      "La formule diffère selon le sexe : le coefficient appliqué n’est pas le même pour la femme et pour l’homme.";

  static const String infoBody5 =
      "Cette estimation doit être interprétée comme un repère général et non comme une valeur absolue.";

  static const String resultHint =
      "Le résultat affiché correspond à l’estimation du poids idéal selon la formule de Lorentz.";

  static const String emptyResultHint =
      "Aucun résultat pour le moment. Sélectionne le sexe, saisis la taille puis lance le calcul.";
}
...
class _IdealWeigthLorentzViewState extends State<IdealWeigthLorentzView>
  ...
  void _compute() {
    ...
    // sexValue2 => 2.5 (souvent femme), sexValue3 => 4 (souvent homme)
    final k = (sexCtl.text == _TXT.sexValue2) ? 2.5 : 4.0;
    final ideal = hCm - 100.0 - ((hCm - 150.0) / k);
                                  ...
                                  const SliverToBoxAdapter(
                                    child: Padding(
                                      ...
                                      child: _ImageInfoCard(
                                        ...
                                        title: "Définition",
                                        body:
                                            "La méthode de Lorentz estime un poids idéal théorique à partir de la taille et d’un coefficient différent selon le sexe.",
                                      ),
                                    ),
                                  ),
                                  ...
                                  const SliverToBoxAdapter(
                                    child: Padding(
                                      ...
                                      child: _ImageInfoCard(
                                        ...
                                        body:
                                            "Cette formule est utile comme repère rapide, mais elle doit être complétée par d’autres indicateurs pour une analyse plus réaliste.",
                                      ),
                                    ),
                                  ),
