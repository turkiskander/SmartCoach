// lib/features/.../ideal_weigth_monnerot_view.dart
//
// ✅ Logique Monnerot inchangée
...
class _TXT {
  static const String screenTitle = "Ideal Weight Monnerot";

  static const String introTitle = "Méthode de Monnerot-Dumaine";
  static const String introSubtitle =
      "Estime le poids idéal selon la taille et le tour de taille.";

  static const String calcTitle = "Calculateur";
  static const String calcDesc =
      "Saisis la taille et le tour de taille, puis lance le calcul.";

  static const String height = "Taille";
  static const String waist = "Tour de taille";
  ...
  static const String chipMethod = "Méthode Monnerot";
  ...
  static const String infoBody1 =
      "La méthode de Monnerot-Dumaine estime le poids idéal à partir de la taille et du tour de taille.";
  static const String infoBody2 =
      "Elle apporte une nuance par rapport aux formules très simples, car elle intègre une mesure corporelle supplémentaire.";
  static const String infoBody3 =
      "Le résultat reste une estimation théorique et ne remplace pas une évaluation médicale ou sportive complète.";
  static const String infoBody4 =
      "Cette formule est souvent utilisée comme repère général pour apprécier une corpulence théorique.";
  static const String infoBody5 =
      "Le résultat doit être interprété avec prudence, car il ne prend pas en compte la masse musculaire ni la composition corporelle.";

  static const String formulaTitle = "Formule Monnerot-Dumaine";
  static const String formula = "Poids idéal = (T − 100 + (4 × TT)) / 2";

  static const String resultHint =
      "Le résultat affiché correspond à l’estimation du poids idéal selon la formule de Monnerot-Dumaine.";
...
class _IdealWeigthMonnerotViewState extends State<IdealWeigthMonnerotView>
  ...
  final TextEditingController waistCtl = TextEditingController(text: "0");
  ...
  void _compute() {
    ...
    final w = _safeDouble(waistCtl.text);
                                  ...
                                  const SliverToBoxAdapter(
                                    child: Padding(
                                      ...
                                      child: _ImageInfoCard(
                                        ...
                                        body:
                                            "La méthode de Monnerot-Dumaine ajoute le tour de taille à la taille pour affiner l’estimation du poids idéal théorique.",
                                      ),
                                    ),
                                  ),
                                  const SliverToBoxAdapter(
...
class _CalcCard extends StatelessWidget {
  ...
  final TextEditingController waistCtl;
  final VoidCallback onCompute;

  const _CalcCard({
    required this.heightCtl,
    required this.waistCtl,
