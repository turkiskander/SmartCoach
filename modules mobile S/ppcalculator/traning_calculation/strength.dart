// lib/feature/ppCalculator/traning_calculation/strength.dart
//
...
class _TXT {
  static const String screenTitle = "Strength";
  static const String bannerTitle = "Strength Calculator";
  static const String bannerSubtitle =
      "Enter the lifted weight and repetitions to estimate concentric, isometric and eccentric strength.";

  static const String weightLabel = "Weight Lifted";
  static const String weightHint = "e.g. 80";
  static const String weightSuffix = "kg";

  static const String repsLabel = "Repetitions";
  static const String repsHint = "e.g. 6";
  ...
  static const String concentricLabel = "Concentric (1RM)";
  static const String isometricLabel = "Isometric (+20%)";
  static const String eccentricLabel = "Eccentric (+30%)";

  static const String invalidSnack = "Invalid input";
}

class _StrengthState extends State<Strength> with TickerProviderStateMixin {
  static const String _bg = "assets/images/BgS.jfif";

  final TextEditingController weightController = TextEditingController();
  final TextEditingController repetitionstController = TextEditingController();
  ...
  void getResult(dynamic weightRaw, dynamic repetitionsRaw, BuildContext context) {
    if (_loading) return;
    setState(() => _loading = true);

    final String wStr = weightRaw.toString().trim().replaceAll(',', '.');
    final String rStr = repetitionsRaw.toString().trim();

    final double? w = double.tryParse(wStr);
    final int? r = int.tryParse(rStr);
    ...
    final double oneRm = w * (1 + r / 30.0);

    setState(() {
      concentric = oneRm.toStringAsFixed(1);
      isometric = (oneRm * 1.20).toStringAsFixed(1);
      eccentric = (oneRm * 1.30).toStringAsFixed(1);
      _loading = false;
    });
  }
  ...
  void dispose() {
    ...
    repetitionstController.dispose();
    super.dispose();
  }
                        ...
                        children: [
                            ...
                            child: Column(
                              children: [
                                _InputField(
                                  ...
                                  label: _TXT.weightLabel,
                                  hint: _TXT.weightHint,
                                  suffix: _TXT.weightSuffix,
                          ...
                          _Glass(
                            ...
                            child: _ResultsTable(
                              ...
                              rows: [
                                _ResultRow(
                                  label: _TXT.concentricLabel,
                                  value: concentric.isEmpty ? '—' : '$concentric kg',
                                ),
                                _ResultRow(
                                  label: _TXT.isometricLabel,
                                  value: isometric.isEmpty ? '—' : '$isometric kg',
                                ),
                                _ResultRow(
                                  label: _TXT.eccentricLabel,
                                  value: eccentric.isEmpty ? '—' : '$eccentric kg',
                                ),
                              ],
                            ),
                          ),
